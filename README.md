...
Road Bikes dominates ($2.1M), with only 3 categories generating ~80% of revenue. **→ Action:** Diversify product portfolio to reduce risk.
 
**2. Fast-Growing Segments** 
Mountain Frames (+510%), Socks (+421%), Road Frames (+389%). **→ Action:** Increase production & marketing budget.
 
**3. Territorial Opportunity** 
Territory 4 is 4x stronger than others. **→ Action:** Replicate its success factors across regions.
 
**4. Customer Retention Crisis** 
96% of 2014 customers never returned. **→ Action:** Launch re-engagement campaigns to reduce churn.
 
**5. Excess Inventory** 
Stock-to-sales ratio >20x for slow-moving products. **→ Action:** Reduce overstock and free up working capital.
