...
🗺️ **Territorial Dominance:** Territory 4 is 4x stronger than others (3,238→11,632 orders, 2011-2014). **Action:** Investigate success factors and replicate in underperforming territories.
...
⚠️ **Excess Stock Levels:** Stock-to-sales ratio >20x for slow-moving frames (27 units in stock, 1 sold). **Action:** Free up $M+ in working capital by reducing overstock.
